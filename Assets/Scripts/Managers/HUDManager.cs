...
public class HUDManager : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI _fishCollectibleText;
    #endregion
    ...
    public void UpdateFishCollectibleText(int currentFish)
    {
        //Update the text to display the current amount of tokens collected
        _fishCollectibleText.text = $"x{currentFish:0}";
    }
    #endregion
}
